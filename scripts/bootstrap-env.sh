...

{
    ...
    printf 'APP_I18N_CACHE_MAX_ENTRIES=%s\n' "${APP_I18N_CACHE_MAX_ENTRIES:-50000}"
    printf 'APP_I18N_CACHE_TTL=%s\n' "${APP_I18N_CACHE_TTL:-5m}"
